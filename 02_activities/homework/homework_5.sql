...
CROSS JOIN 
    customer c -- This multiplies each vendor-product combination with every customer
GROUP BY 
    v.vendor_name, 
    p.product_name, 
    vi.original_price;
...
SET current_quantity = (
    ...
    WHERE new_vendor_inventory.product_id = product_units.product_id);	
